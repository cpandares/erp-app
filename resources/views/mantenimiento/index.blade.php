<x-layout.default>
    ...
    <div x-data="contacts({{ $mantenimientos->toJson() }})" x-init="init()">
        <div class="flex items-center justify-between flex-wrap gap-4">
            <h2 class="text-xl">Taller</h2>
                ...
                <div class="table-responsive">
                    <table class="table-striped table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                    <td>
                                        {{ $item->coche->cliente->name }}
                                    </td>

                                    <td>
                                        {{ $item->coche->marca }} {{ $item->coche->model }}
                                    </td>
                                    <td>
                                        {{ $item->description }}
                                    </td>
                                    ...
                                    <td class="!text-center">
                                        <button type="button" class="btn btn-outline-primary p-0 h-7 w-7 rounded-full"
                                            @click="editUser({{ $item }})">
                                        ...
                                        <button type="button" class="btn btn-outline-danger p-0 h-7 w-7 rounded-full"
    ...
    <script>
        document.addEventListener("alpine:init", () => {
            Alpine.data("contacts", (mantenimientos) => ({
                defaultParams: {
                    id: null,
                    cliente: '',
                    coche: '',
                ...
                filterdContactsList: [],
                searchUser: '',
                contactList: mantenimientos.map(mantenimiento => ({
                    id: '1',
                    cliente: 'cliente',
                    coche: 'coche',
