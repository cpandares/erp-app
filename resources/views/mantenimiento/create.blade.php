            ...
            <form action="{{ route('mantenimientos.store') }}" method="POST">
                ...
                <div class="-mx-3 md:flex mb-6">
                    ...
                    <div class="md:w-1/2 px-3">
                        ...
                        <select name="servicio" id="servicio" class="block appearance-none w-full bg-grey-lighter border border-grey-lighter text-grey-darker py-3 px-4 pr-8 rounded">
                            <option value="">Seleccione un servicio</option>
                            @foreach ($servicios as $item)
                                <option value="{{ $item->id }}" {{ old('servicio') == $item->id ? 'selected' : '' }}>{{ $item->name }}</option>
                            @endforeach
                        </select>
                        @error('tipo_servicio')
                            <p class="text-red-500 text-xs italic">{{ $message }}</p>
                ...
                <div class="-mx-3 md:flex mb-6">
                    ...
                    <div class="md:w-1/2 px-3">
                        ...
                        <input type="text" name="valor" id="valor" class="appearance-none block w-full bg-grey-lighter text-grey-darker border border-grey-lighter rounded py-3 px-4" placeholder="Ingrese el valor del servicio" value="{{ old('valor') }}">
                        @error('valor')
                            <p class="text-red-500 text-xs italic">{{ $message }}</p>
                        @enderror
                    </div>
