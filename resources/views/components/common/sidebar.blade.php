            ...
            <div class="flex justify-between items-center px-4 py-3">
                <a href="{{url('/')}}" class="main-logo flex items-center shrink-0">
                    <img class="w-8 ml-[5px] flex-none" src="/assets/images/logo.svg"
                        alt="image" />
                    <span
                        class="text-2xl ltr:ml-1.5 rtl:mr-1.5  font-semibold  align-middle lg:inline dark:text-white-light">CarsService</span>
                </a>
                <a href="javascript:;"
            ...
            <ul class="perfect-scrollbar relative font-semibold space-y-0.5 h-[calc(100vh-80px)] overflow-y-auto overflow-x-hidden  p-4 py-0"
                ...
                <li class="nav-item">
                    <ul>
                        ...
                        <li class="nav-item">
                            <a href="{{url('servicios')}}" class="group">
                                <div class="flex items-center">
                        ...
                        <li class="nav-item">
                            <a href="{{url('empleados')}}" class="group">
                                <div class="flex items-center">
